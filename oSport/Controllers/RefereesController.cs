...
namespace oSport.Controllers
{
    ...
    public class RefereesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var dbUser = await _context.Referees.SingleOrDefaultAsync(a => a.IdentityUserId == userId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdentityUserId,FirstName,LastName,PhoneNumber")] Referee referee)
        {
            if (id != referee.Id)
            {
                return NotFound();
